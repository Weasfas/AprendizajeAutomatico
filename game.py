...
class Game:
	...
	if (not os.path.isfile("./all_data_pacman.arff")):
		...
		@ATTRIBUTE move1 {WEST,STOP,EAST,NORTH,SOUTH}
		@ATTRIBUTE move2 {WEST,STOP,EAST,NORTH,SOUTH}
		@ATTRIBUTE ghost_distance NUMERIC
		@ATTRIBUTE score NUMERIC
		@ATTRIBUTE pacman_direction {WEST,STOP,EAST,NORTH,SOUTH}
        @ATTRIBUTE ghost_distanceNext NUMERIC
        ...
        while not self.gameOver:
            ...
            if agent == self.agents[0]:
                fil.write(agent.hola(self.state))
