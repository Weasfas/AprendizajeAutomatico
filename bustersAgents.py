...
class BustersKeyboardAgent(BustersAgent, KeyboardAgent):
	...
	distances = map(lambda a: 9999 if (a==None) else a, gameState.data.ghostDistances)
        GD=min (distances)
        mensaje = "\t" + str(mW) + "," + str(mP) + "," + str(mE) + "," + str(mN) + "," + str(mS) + "," + str(GD) + "," + str(gameState.getScore()) + "," + str(gameState.data.agentStates[0].getDirection()) + "," + '\n' +'\t'
        return mensaje
