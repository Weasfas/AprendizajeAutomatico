...
class BustersKeyboardAgent(BustersAgent, KeyboardAgent):
    ...
    def hola(self, gameState):
        ...
        if (gameState.data.ghostDistances[0] is not None): gD0=gameState.data.ghostDistances[0]
        if (gameState.data.ghostDistances[1] is not None): gD1=gameState.data.ghostDistances[1]
        if (gameState.data.ghostDistances[2] is not None): gD2=gameState.data.ghostDistances[2]
        if (gameState.data.ghostDistances[3] is not None): gD3=gameState.data.ghostDistances[3]
        if (gameState.getDistanceNearestFood() is not None): com=gameState.getDistanceNearestFood()
        mensaje = "\t" + str(mW) + "," + str(mP) + "," + str(mE) + "," + str(mN) + "," + str(mS) + "," + str(gD0) + "," + str(gD1) + "," + str(gD2) + "," + str(gD3) + "," + str(gameState.getGhostDirections().get(0)) + "," + str(gameState.getGhostDirections().get(1)) + "," + str(gameState.getGhostDirections().get(2)) + "," + str(gameState.getGhostDirections().get(3)) + "," + str(gameState.getGhostPositions()[0][0]) + "," + str(gameState.getGhostPositions()[0][1]) + "," + str(gameState.getGhostPositions()[1][0]) + "," + str(gameState.getGhostPositions()[1][1]) + "," + str(gameState.getGhostPositions()[2][0]) + "," + str(gameState.getGhostPositions()[2][1]) + "," + str(gameState.getGhostPositions()[3][0]) + "," + str(gameState.getGhostPositions()[3][1]) + "," + str(com) + "," + str(gameState.getScore()) + "," + str(gameState.getNumLivingGhosts()) + "," + str(gameState.data.agentStates[0].getDirection()) + "," + '\n' +'\t'
        return mensaje
