...
class BustersKeyboardAgent(BustersAgent, KeyboardAgent):
    ...
    def hola(self, gameState):
        ...
        mensaje = "\t" + str(mW) + "," + str(mP) + "," + str(mE) + "," + str(mN) + "," + str(mS) + "," + str(gD0) + "," + str(gD1) + "," + str(gD2) + "," + str(gD3) + "," + str(gameState.data.agentStates[0].getDirection()) + "," + str(gameState.getGhostDirections().get(0)) + "," + str(gameState.getGhostDirections().get(1)) + "," + str(gameState.getGhostDirections().get(2)) + "," + str(gameState.getGhostDirections().get(3)) + "," + str(gameState.getGhostPositions()[0][0]) + "," + str(gameState.getGhostPositions()[0][1]) + "," + str(gameState.getGhostPositions()[1][0]) + "," + str(gameState.getGhostPositions()[1][1]) + "," + str(gameState.getGhostPositions()[2][0]) + "," + str(gameState.getGhostPositions()[2][1]) + "," + str(gameState.getGhostPositions()[3][0]) + "," + str(gameState.getGhostPositions()[3][1]) + "\n" + '\t'
        return mensaje
